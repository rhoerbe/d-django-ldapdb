...
RUN chmod +x /scripts/* \
 && mkdir -p /opt/django_ldapapp /var/db/openldap /var/log/openldap /var/run/openldap \
 && chown -R $USERNAME /etc/openldap /opt/django_ldapapp /var/db/openldap /var/log/openldap /var/run/openldap
